bl_info = {
    ...
    "warning": "Before running this add-on, Audacity must be running with Preferences > Enabled(after a restart of Audacity).",
    "category": "Sequencer",
}
...
class SEQUENCER_PT_audacity_tools(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if props.audacity_mode in {"STRIP", "SEQUENCE", "SELECTION"}:
